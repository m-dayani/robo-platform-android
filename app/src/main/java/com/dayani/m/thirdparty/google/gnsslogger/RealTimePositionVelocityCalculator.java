        ...
        new Runnable() {
          ...
          public void run() {
            try {
              ...
              Log.e(
                  com.dayani.m.thirdparty.google.gnsslogger.MeasurementProvider.TAG,
          ...
          new Runnable() {
            ...
            public void run() {
              ...
              try {
                ...
                Log.e(com.dayani.m.thirdparty.google.gnsslogger.MeasurementProvider.TAG,
                        " Exception setting reference location : ", e);
              }
            }
          };
...
//              }
  ...
  private void logEvent(String tag, String message, int color) {
    String composedTag = com.dayani.m.thirdparty.google.gnsslogger.MeasurementProvider.TAG + tag;
