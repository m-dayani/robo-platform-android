...
import com.dayani.m.roboplatform.BuildConfig;
...
public class FileLogger implements GnssListener {
    ...
    private static final String PATH_PREFIX = "DCIM/Files";
    ...
    public void startNewLog() {
        synchronized (mFileLock) {
            ...
            if (Environment.MEDIA_MOUNTED.equals(state)) {
                baseDirectory = new File(Environment.getExternalStorageDirectory(), PATH_PREFIX);
            ...
            try {
                ...
                currentFileWriter.write(COMMENT_START);
                currentFileWriter.write(
                        "Fix,Provider,Latitude,Longitude,Altitude,Speed,Accuracy,(UTC)TimeInMs,SystemTimestampNs");
                currentFileWriter.newLine();
                currentFileWriter.write(COMMENT_START);
                currentFileWriter.newLine();
                currentFileWriter.write(COMMENT_START);
